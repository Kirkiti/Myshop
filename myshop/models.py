...
class Vendor(models.Model):
    ...
    title = models.CharField(max_length=100, default="Shopspace")
    image = models.ImageField(upload_to=user_directory_path, default="Vendor.jpg")
    description = models.TextField(null=True, blank=True, default="I am an amaizing vendor")

    address = models.CharField(max_length=100, default="254 Main Street")
    contact = models.CharField(max_length=100, default="0728374304")
...
class CartOrderItems(models.Model):
    ...
    price = models.DecimalField(max_digits=999999999999999, decimal_places=2, default="1.99")
    total = models.DecimalField(max_digits=999999999999999, decimal_places=2, default="1.99")
